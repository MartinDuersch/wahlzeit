...
public abstract class ModelMain extends AbstractMain {
	...
	public void loadGlobals() throws SQLException {
		...
		if (result.next()) {
			...
			CartesianCoordinate.setLastCoordinateId(lastCoordinateId);		
			...
			Location.setLastLocationId(lastLocationId);		
